public class Currency
{
	...
	{
		var universalValue = amount * _rate;
		universalValue = Math.floor(universalValue);

		return (int)universalValue;
	}
	...
	{
		var otherCurrencyUniversalValue = othercurrency.universalValue(amount);

		return universalValue(otherCurrencyUniversalValue);
	}
