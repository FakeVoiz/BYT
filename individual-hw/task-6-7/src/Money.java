public class Money implements Comparable
{
	...
	{
		return _currency.universalValue(_amount);
	}
	...
	public boolean equals(Object other)
	{
		if(other instanceof Money)
			return universalValue().equals(((Money)other).universalValue());
	...
	{
		return (_currency == other.getCurrency() ?
				new Money(_amount + other.getAmount(), _currency) :
				new Money((int) (_amount + other.universalValue().doubleValue() * _currency.get_rate()), _currency));
	}
	...
	{
		return other.getCurrency() == _currency ?
				new Money(_amount - other.getAmount(), _currency) :
				new Money(_amount - other.universalValue(), _currency);
	}
	...
	{
		return  _amount + " " + _currency.get_name();
	}
}